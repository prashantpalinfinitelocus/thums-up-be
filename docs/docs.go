    ...
    "paths": {
        ...
        "/thunder-seat": {
            "post": {
                ...
                "description": "Submit an answer to a Thunder Seat question for the current week. Requires authentication.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.ThunderSeatSubmitRequest"
                        }
                    }
                ],
                "responses": {
